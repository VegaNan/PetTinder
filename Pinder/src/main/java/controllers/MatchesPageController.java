	...
	public void setPet() {
		if(currentPage <= animalIds.length/10) {
			...
			while(currentAnimal == animalIds.length && slot < 10) {
				...
				switch(slot){
				case 0:
					petimg0.setImage(null);
					pettxt0.setText("");
					break;
				case 1:
					petimg1.setImage(null);
					pettxt1.setText("");
					break;
				case 2:
					petimg2.setImage(null);
					pettxt2.setText("");
					break;
				case 3:
					petimg3.setImage(null);
					pettxt3.setText("");
					break;
				case 4:		
					petimg4.setImage(null);
					pettxt4.setText("");
					break;
				case 5:
					petimg5.setImage(null);
					pettxt5.setText("");
					break;
				case 6:
					petimg6.setImage(null);
					pettxt6.setText("");
					break;
				case 7:
					petimg7.setImage(null);
					pettxt7.setText("");
					break;
				case 8:
					petimg8.setImage(null);
					pettxt8.setText("");
					break;
				case 9:
					petimg9.setImage(null);
					pettxt9.setText("");
					break;
